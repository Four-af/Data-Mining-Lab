...
def remove_stopwords(text):
    stopwords = read_file('Similar_documents_P2/stopWords.txt').split('\n')
...
text=read_file('Similar_documents_P2/documents.txt')
documents =text.split('\n')
documents = [clean_text(doc) for doc in documents]
print(documents)

#find frequency of words in each document and build an attribute table using pandas
