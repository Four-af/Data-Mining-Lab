...
QUESTIONS_PATH=['Domain_Questions_Answers_P3/questions/q1.txt','Domain_Questions_Answers_P3/questions/q2.txt','Domain_Questions_Answers_P3/questions/q3.txt','Domain_Questions_Answers_P3/questions/q4.txt','Domain_Questions_Answers_P3/questions/q5.txt']
ANSWERS_PATH=['Domain_Questions_Answers_P3/answers/a1.txt', 'Domain_Questions_Answers_P3/answers/a2.txt','Domain_Questions_Answers_P3/answers/a3.txt','Domain_Questions_Answers_P3/answers/a4.txt','Domain_Questions_Answers_P3/answers/a5.txt']

ANSWERS_LIST=[];

#  remove unwanted words like , . from starting and ending of the word
...
new_ques_freq=findFrequencyOfWordInDocument('Domain_Questions_Answers_P3/new_question.txt');
...
if max_cosine_similarity >= 0.4:
    data = []
    with open(QUESTIONS_PATH[suitable_ans_indx], 'r') as closest_question:
        data = closest_question.read()
    print("\n++ Closest Question :: ", data)
    print("\n++ Answer:: ", end="")
    print(ANSWERS_LIST[suitable_ans_indx])
    print("\n++ Cosine Similarity:: " ,max_cosine_similarity)
else:
    print("-----No closest similarity----\n----Insufficient dataset----\n")
